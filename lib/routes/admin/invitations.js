...
function approve (req, res) {
	models.Invitation.findOne({
		...
		emailVerification.generateCode(function(code) {
			...
			invitation.user.sendEmail('NodeGear Registrations '+
				'<registration@nodegear.com>', 'Confirm Your NodeGear Account',
				'emails/register.jade', {
			...
			res.send({
				message: 'User Invited. They were sent an email confirmation email.' +
					' Might also want to personally notify them.'
			});
		});
	});
}
